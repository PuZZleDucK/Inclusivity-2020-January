...
- February 27, and participants include Tumblr, Etsy, Vimeo, Medium, Namecheap, Imgur, Sonos, and DuckDuckGo.
- Internet users will be encouraged to sound the alarm on social media, driving phone calls, emails, and tweets to Senators and Representatives calling on them to pass the CRA
- Announce: https://medium.com/@fightfortheftr/major-websites-like-tumblr-medium-etsy-and-vimeo-are-joining-feb-27-day-of-action-to-block-the-ec8ef06e4c99
- Site: http://votefornetneutrality.com/
Note:
notes
...
<hr />
### 20 Years of the Open Source Initiative, Anniversary Celebrations and Outreach Programs
...
- Article: https://opensource.com/article/18/2/coining-term-open-source-software
- Wikipedia: https://en.wikipedia.org/wiki/History_of_free_and_open-source_software#The_launch_of_Open_Source
- Stallman: https://www.gnu.org/philosophy/open-source-misses-the-point.html
Note:
notes
...
- Article: https://www.theguardian.com/technology/2018/jan/24/facebook-regulated-cigarette-industry-salesforce-marc-benioff-social-media
Note:
notes
...
- Site: http://humanetech.com/problem/
Note:
notes
...
- Article: https://torrentfreak.com/blizzard-targets-fan-created-world-of-warcraft-legacy-server-180203/
- DMCA: https://github.com/github/dmca/commit/d4137e11e59790e3f03448f610da9afc2cc9c6e2
- Exemption: https://games.slashdot.org/story/17/12/25/0138206/dmca-exemption-sought-to-save-abandoned-online-games
Note:
notes
...
- Article: https://www.eff.org/deeplinks/2018/02/john-perry-barlow-internet-pioneer-1947-2018
Note:
notes
...
- Google does screen apps submitted to the Play store to filter out malware, but the process is still mostly automated and very quick -- too quick to detect Android malware before it's published, as we've seen
- Installing F-Droid isn't a silver bullet, but it's the first step in protecting yourself from malware
...
- Article: https://www.bleepingcomputer.com/news/linux/lkrg-linux-to-get-a-loadable-kernel-module-for-runtime-integrity-checking/
- Site: http://www.openwall.com/lkrg/
- Wiki: http://openwall.info/wiki/p_lkrg/Main
Note:
notes
...
- Article: https://lwn.net/Articles/744730/
- First Edition: https://lwn.net/1998/0122/
Note:
notes
...
- OpenPGP Support
- Revamped design with new table styles
- improved Notebookbars
- new gradients, new Elementary icons, menu and toolbar improvements
- Compatibility with the EPUB3
- Announce: http://news.softpedia.com/news/libreoffice-6-0-open-source-office-suite-officially-released-here-s-what-s-new-519623.shtml
Note:
notes
...
- Article: http://www.zdnet.com/article/firefox-59-will-stop-websites-snooping-on-where-youve-just-been/
Note:
notes
...
- Article: https://www.bleepingcomputer.com/news/software/mozilla-restricts-all-new-firefox-features-to-https-only/
Note:
notes
...
- Article: https://www.phoronix.com/scan.php?page=news_item&px=Ubuntu-18.04-Xorg-Default
Note:
notes
...
<hr />
### Wine 3.0 Released
- Android driver that lets users run Windows apps and games on Android-powered machines
- Direct3D 11 support enabled by default for AMD Radeon and Intel GPUs
...
- Article: http://www.zdnet.com/article/google-moves-to-debian-for-in-house-linux-desktop/
Note:
notes
...
- Video: https://www.youtube.com/watch?time_continue=1&v=ltzy5vRmN8Q
- Article: http://variety.com/2018/politics/news/burger-king-net-neutrality-video-1202676499/
Note:
notes
...
- Article: https://motherboard.vice.com/en_us/article/437dmj/fcc-broadband-deployment-report-ajit-pai-net-neutrality
- Report: https://transition.fcc.gov/Daily_Releases/Daily_Business/2018/db0202/DOC-349016A1.pdf
Note:
notes
